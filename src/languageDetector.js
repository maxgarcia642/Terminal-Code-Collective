...
const LANGUAGE_VERSIONS = {
  ...
  [LANGUAGES.CPP]: '10.2.0',
  [LANGUAGES.C]: '10.2.0',
  [LANGUAGES.CSHARP]: '6.12.0',
  [LANGUAGES.GO]: '1.16.2',
  [LANGUAGES.RUST]: '1.68.2',
  [LANGUAGES.RUBY]: '3.0.1',
  [LANGUAGES.PHP]: '8.2.3',
  [LANGUAGES.TYPESCRIPT]: '5.0.3',
  [LANGUAGES.SWIFT]: '5.3.3',
  [LANGUAGES.KOTLIN]: '1.8.20',
  [LANGUAGES.SCALA]: '3.2.2',
  [LANGUAGES.R]: '4.1.1',
  [LANGUAGES.PERL]: '5.36.0',
  [LANGUAGES.LUA]: '5.4.4',
  [LANGUAGES.BASH]: '5.2.0',
  [LANGUAGES.HASKELL]: '9.0.1',
};
